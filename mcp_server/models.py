...
class CertificateParameters(BaseModel):
    CertificateType: str = Field(
        ..., description='CERTIFICATE TYPE', examples=['REGULAR']
    )
    DOB: str = Field(
    ...
    RROLL: str = Field(..., description='Roll No', examples=['857111'])
    month: str = Field(..., description='MONTH', examples=['MAR'])
